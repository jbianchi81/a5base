...
export async function userChangePassword(req : UserRequest,res : Response) {
    if(!pool) {
        res.status(500).send("Database connection not established")
        return
    }
...
export async function viewUser(req : UserRequest,res : Response) {
    if(!pool) {
        res.status(500).send("Database connection not established")
        return
    }
...
export async function viewUsers(req : UserRequest,res : Response) {
    if(!pool) {
        res.status(500).send("Database connection not established")
        return
    }
...
export function newUserForm(req : UserRequest, res : Response) {
    const user = req.user as User_
