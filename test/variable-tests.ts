...
test('setOne', async(t: any) => {
    const variable = new Variable({nombre:"aaa"})
    // should not throw
    variable.setOne("timeSupport",{days: 1})
})

test('setTSOneFromString', async(t: any) => {
    const variable = new Variable({nombre:"aaa"})
...
test('setTSFromString', async(t: any) => {
    const variable = new Variable({nombre:"aaa"})
    // should not throw    
...
test('variable read', async(t : any) => {
