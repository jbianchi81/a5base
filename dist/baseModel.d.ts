...
declare type KeyValueTuple = [key: string, value: unknown];
...
export declare function writeModelToFile(model: AnyClass, output_file: string, output_format: string): Promise<void>;
...
export default class baseModel {
    ...
    static createFromFile(input_file: any, input_format: any, options: any): Promise<AnyClass | AnyClass[]>;
    /**
     ...
     * @returns
     */
    static read(filter?: {}, options?: {}): Promise<any>;
    build_update_query(update_keys?: never[]): {
        string: string;
        params: any[];
    } | undefined;
    /**
     ...
     */
    static update(updates?: KeyValueTuple[]): Promise<any[]>;
    update(changes?: {}): Promise<this>;
    static delete(filter?: {}): Promise<any>;
    partial(columns?: never[]): any;
